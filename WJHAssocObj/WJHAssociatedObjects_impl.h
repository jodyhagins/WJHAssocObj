...
inline void WJHAssociateStrongly(id object, void const *key, id value, BOOL atomically)
{
...
inline void WJHAssociateCopy(id object, void const *key, id value, BOOL atomically)
{
    assert(!_wjhIsProxyClass(value));
    objc_setAssociatedObject(object, key, value, atomically ? OBJC_ASSOCIATION_COPY : OBJC_ASSOCIATION_COPY_NONATOMIC);
}

inline void WJHAssociatePointer(id object, void const *key, void const *value)
{
    objc_setAssociatedObject(object, key, (__bridge id)(value), OBJC_ASSOCIATION_ASSIGN);
}

inline void WJHAssociateInteger(id object, void const *key, intptr_t value)
{
    objc_setAssociatedObject(object, key, (__bridge id)((void*)value), OBJC_ASSOCIATION_ASSIGN);
}

inline void * WJHGetAssociatedPointer(id object, void const *key)
{
    return (__bridge void*)objc_getAssociatedObject(object, key);
}

inline intptr_t WJHGetAssociatedInteger(id object, void const *key)
{
    return (intptr_t)(__bridge void*)objc_getAssociatedObject(object, key);
}

inline void WJHDisassociate(id object, void const *key)
{
